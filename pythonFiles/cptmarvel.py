...
files = readcol.readcol('/mnt/cptmarvel/files.list')
files = files[:,0]
...
for file in files:
    ...
    for i in currenthalo:
        ...
        starmass = float(h[currenthalo].s['mass'].sum())
        gasmass = float(h[currenthalo].g['mass'].sum())
        virialmass = float(starmass+gasmass+h[currenthalo].d['mass'].sum())

#        print starmass
#        print type(starmass)
#        starmass = float(starmass)
#        print type(starmass)
