...
plt.plot(Time[i4], BHDistance[i3], label= "black hole 16")
plt.plot(Time[i5], BHDistance[i3], label= "black hole 2a")
plt.plot(Time[i6], BHDistance[i3], label= "black hole 2b")
plt.plot(Time[i7], BHDistance[i3], label= "black hole 1")
plt.plot(Time[i8], BHDistance[i3], label= "black hole 3")
